...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/grpc-cpp-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/grpc-cpp-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add grpcio grpcio-tools libgrpc
# for installing globally
pixi global install grpcio grpcio-tools libgrpc
```
...
It is possible to list all of the versions of `grpcio` available on your platform:
...
```
pixi search grpcio --channel conda-forge
```
